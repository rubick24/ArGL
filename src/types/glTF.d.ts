...
export interface Material {
   ...
   */
  emissiveTexture?: PurpleTextureInfo
  /**
   * Dictionary object with extension-specific objects.
   */
  extensions?: { [key: string]: { [key: string]: any } }
 ...
 */
export interface PurpleTextureInfo {
  /**
   * Dictionary object with extension-specific objects.
   */
  extensions?: { [key: string]: { [key: string]: any } }
...
export interface MaterialPBRMetallicRoughness {
   ...
   */
  baseColorTexture?: FluffyTextureInfo
  /**
   * Dictionary object with extension-specific objects.
   */
  extensions?: { [key: string]: { [key: string]: any } }
   ...
   */
  metallicRoughnessTexture?: TentacledTextureInfo
  /**
 ...
 * Reference to a texture.
 */
export interface FluffyTextureInfo {
  /**
   * Dictionary object with extension-specific objects.
   */
  extensions?: { [key: string]: { [key: string]: any } }
 ...
 * Reference to a texture.
 */
export interface TentacledTextureInfo {
  /**
   * Dictionary object with extension-specific objects.
   */
  extensions?: { [key: string]: { [key: string]: any } }
